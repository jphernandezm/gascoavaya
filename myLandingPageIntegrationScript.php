 ...
 * of a PHP based landing page integration.
...
class LandingPageIntegration
{
     ...
     * including the landing page result service.
     *
     * @var string
     */
     ...
     * which is used for processing the landing page results.
     *
     * @var string
     */
     ...
     * for processing the requests received from landing pages.
     */
     ...
     * to ensure correct landing page integration.
     */
    private function handlePostRequest()
    {
        ...
        // optional: add the campaign id to connect all landing page interactions to your campaign
